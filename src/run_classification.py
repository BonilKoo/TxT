...
#     def __init__(self, n_genes, d_embed, dropout=0.1, aggfunc='Flatten', d_hidden1=128, d_hidden2=64, slope=0.2): # regression
    def __init__(self, n_genes, d_embed, dropout=0.1, aggfunc='Flatten', d_hidden1=128, d_hidden2=64, slope=0.2, d_output=1): # classification
...
#         self.linear_3 = nn.Linear(d_hidden2, 1) # regression
        self.linear_3 = nn.Linear(d_hidden2, d_output) # classification
...
#                  aggfunc='Flatten', d_hidden1=128, d_hidden2=64, slope=0.2): # regression
                 aggfunc='Flatten', d_hidden1=128, d_hidden2=64, slope=0.2, d_output=1): # classification
...
#                                                      aggfunc, d_hidden1, d_hidden2, slope).to(device) # regression
                                                     aggfunc, d_hidden1, d_hidden2, slope, d_output).to(device) # classification
...
def eval_result_regression(model, dataloader, device): # regression
    y_true = np.empty(0)
