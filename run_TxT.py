...
def parse_args():
    ...
    parser.add_argument('--output_file', required=True, help='(csv) A file containing clinical feature data. The format is organized with a header line indicating the type of data and subsequent rows containing sample-specific information.')
    ...
    parser.add_argument('--task_file', default=None, help='(csv) Only for multi-task learning. A csv file that outlines a set of tasks. Each row in the file represents a specific task, and the information is organized into two columns: "task name" and "prediction type".')
    ...
    parser.add_argument('--patience', type=int, default=30, help='(int) Number of epochs with no improvement in validation loss after which training will be stopped early. (default: 30)')
    parser.add_argument('--max_epoch', type=int, default=1000, help='(int) Maximum number of training epochs. (default: 1000)')

    parser.add_argument('--n_heads', type=int, default=4, help='(int) Number of attention heads. (default: 4)')
    ...
    parser.add_argument('--n_layers', type=int, default=8, help='(int) Number of layers in transformer. (default: 8)')
    ...
    parser.add_argument('--d_hidden2', type=int, default=64, help='(int) Dimensionality of the second hidden layer in task-specific layer. (default: 64)')
