...
def parse_args():
    ...
    parser.add_argument('--task', required=True, choices=['regression', 'classification', 'survival', 'multitask'])
    ...
    parser.add_argument('--scaler', choices=[None, 'MinMax', 'Standard'], default='MinMax', help='(str) A data normalization method. You can choose among [MinMax/Standard/None]. The gene expression levels were normalized by using the expression values of the traning set.')
    ...
    parser.add_argument('--norm_first', action='store_true', help='An option to perform LayerNorms before other attention and feedforward operations, otherwise after.')
